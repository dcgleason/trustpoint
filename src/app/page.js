                ...
                <ul className="space-y-6">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">The AI chatbots & AI agents we implement for you are trained on your company data, so they can qualify leads, offer self-service support specifically tailored to your business (e.g. booking appointments, processing orders, etc.), and free up your sales & customer service people to focus more on closing deals and delighting customers.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="text-green-500 mr-4 flex-shrink-0 w-8 h-8" />
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md border border-light-blue">
              ...
              <p className="text-navy-blue">Our monthly implementation and support fee is refundable (no questions asked) or cancelable if you aren&apos;t at any time satisfied. We&apos;re that confident in our ability to deliver results you&apos;ll be happy with.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md border border-light-blue">
