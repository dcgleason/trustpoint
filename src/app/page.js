  ...
  return (
    <div className="min-h-screen bg-white text-navy-blue relative overflow-hidden">
      ...
      <main className="container mx-auto px-4 py-8 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold text-navy-blue mb-4 tracking-tight">Elevate your ServiceNow solutions with AI implementations that actually drive meaning results for you.</h1>
          <p className="text-xl md:text-3xl text-light-blue mb-8">Make the most out of ServiceNow&apos;s AI offerings with our seasoned industry experts.</p>
