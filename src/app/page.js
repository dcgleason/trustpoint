          ...
          <div className="w-full sm:w-2/3">
            <div className="relative">
              ...
              <div className="relative bg-white shadow-lg sm:rounded-3xl p-6 sm:p-10">
                <h1 className="text-2xl sm:text-3xl font-extrabold text-center text-gray-900 mb-6">Learn-to-Code Buddy Finder (Boston, MA)</h1>
                <h3 className="text-lg sm:text-xl font-semibold text-center text-gray-700 mb-6">Get paired with a compatible learner in your area - stay motivated, grow and learn together</h3>
                {!submitted ? (
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                      ...
                      >
                        Get Matched & Learn to Code...faster!
                      </button>
                    </div>
                  </form>
                ) : (
