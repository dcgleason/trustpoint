  ...
  return (
    <div className="min-h-screen bg-white text-navy-blue relative overflow-hidden">
      ...
      <main className="container mx-auto px-4 py-8 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold text-navy-blue mb-4 tracking-tight">Bring on an &quot;AI sherpa&quot; for your AI implementation. </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg md:text-xl text-navy-blue mb-6">
                We specialize in integrating cutting-edge AI solutions into your existing tech stack. Our experts (AI sherpas) will help you with:
              </p>
