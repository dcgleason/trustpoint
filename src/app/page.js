          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg md:text-xl text-navy-blue mb-6">
                We are great at helping companies build AI tech stacks that get the most bang for your buck, i.e. measurable and improved ROI. Our AI experts can help you with:
              </p>
