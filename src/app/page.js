          ...
          <div className="w-full sm:w-2/3">
            <div className="relative">
              ...
              <div className="relative bg-white shadow-lg sm:rounded-3xl p-6 sm:p-10">
                ...
                <h2 className="text-lg sm:text-xl font-semibold text-center text-gray-700 mb-6">Get paired with a compatible programmer. Use our Code Buddy toolkit (checklists, project prompts, conversation starters, etc) stay motivated and grow & learn together</h2>
                {!submitted ? (
