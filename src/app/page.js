  ...
  return (
    <div className="min-h-screen bg-white text-navy-blue relative overflow-hidden">
      ...
      <main className="container mx-auto px-4 py-8 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold text-navy-blue mb-4 tracking-tight">Build cost-effective, high ROI AI systems for your start-up. Without the learning curve. </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg md:text-xl text-navy-blue mb-6">
                We are great at helping companies build AI tech stacks that get the most bang for your buck, i.e. measurable results with low AI spend. Our AI sherpas (experts) can help you with:
              </p>
