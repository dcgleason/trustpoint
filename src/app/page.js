    ...
    <div className="min-h-screen bg-white text-navy-blue relative overflow-hidden">
      ...
      <main className="container mx-auto px-4 py-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl md:text-3xl text-light-blue mb-8 italic">AI sales & customer service chatbots built on models trained on <span className="underline">your</span> data. Unconditional, money-back guarantee.</p>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-light-blue">
              ...
              <p className="text-navy-blue">We&apos;ll train your technical team on on code - how to support your AI chatbot and AI agents, or we can offer ongoing technical support for you.</p>
            </div>
          </div>
        </motion.section>
