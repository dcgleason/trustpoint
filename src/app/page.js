                ...
                <ul className="space-y-6">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">The AI chatbots & AI agents we implement for you are trained on your data, so they can qualify leads for your sales & customer service team, offer self-service support specifically tailored to your business, and free up your people to focus more on closing deals and delighting customers.</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="text-green-500 mr-4 flex-shrink-0 w-8 h-8" />
                    <div>
                      ...
                      <p className="text-gray-700">Our monthly implementation and support fee is refundable if you aren&apos;t at any time satisfied. We&apos;re that confident in our ability to deliver results you&apos;ll be happy with.</p>
                    </div>
                  </li>
                </ul>
              </div>
