  ...
  return (
    <div className="min-h-screen bg-white text-navy-blue relative overflow-hidden">
      ...
      <main className="container mx-auto px-4 py-8 relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold text-navy-blue mb-4 tracking-tight">Build cost-effective, high ROI AI systems. Without the learning curve. </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg md:text-xl text-navy-blue mb-6">
                We are great at helping companies get clarity on the AI tech stack that fits their needs, optimizing for increase return on your investment. Our AI experts can help you with:
              </p>
